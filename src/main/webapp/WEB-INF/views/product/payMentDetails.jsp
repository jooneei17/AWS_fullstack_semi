										...
										<div class="col-3 my-auto mr-0 text-end pb-4">
											...
											<span>원</span>
												...
												<c:if test="${non.codeNo eq orderlist.codeNo}">
													<span><a href="${pageContext.request.contextPath}/member/review?payNo=${paylist.payNo}&codeNo=${orderlist.codeNo}" class="btn btn-primary review-write p-0 mt-5 float-end" >리뷰 작성</a></span>
												</c:if>
